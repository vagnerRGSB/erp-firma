...
class Servico extends Migration
{
    public function up()
    {
        ...
        $this->forge->addForeignKey("idCategoriaServico","categoria_servico","idCategoriaServico","cascade","cascade",
        "fk_categoria_servico_has_servico");
        $this->forge->addForeignKey("idOrcamentoServico","orcamento_servico","idOrcamentoServico","cascade","cascade",
