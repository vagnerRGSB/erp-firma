<div class="container">
  <div class="row justify-content-center mt-5">
    <div class="col-md-6 w-100">
      <div class="card">
        <div class="card-body">
          <h2 class="card-title text-center">Listagem de Maquinários</h2>

          <div class="mt-1 mb-1">
            <a class="btn btn-primary" href="<?= url_to("categoria-maquinario.inserir") ?>"><i class="bi bi-plus"></i> Categoria Maquinário</a>
          </div>
          <table class="table">
            <thead>
              <tr>
