                ...
                <div class="card-body">
                    ...
                    <form action="<?= url_to("categoria-servico.onSave") ?>" method="post">
                        ...
                        <div class="mb-3 col-3">
                            <input type="hidden" name="idCategoriaServico" value="<?= $item["idCategoriaServico"] ?>">
                        </div>
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input type="text" name="horaCobrada" class="form-control" id="horaCobrada" aria-describedby="horaCobradaHelp" value="<?= $item["horaCobrada"] ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
